...
df=pd.read_csv(r"D:\CU\spring 2022\nlp\Roku\OS_94_t.csv") # read in the dataframe here


# below here is what you can change as parameters
new_sw=["roku","tv","amazon","ultra","use","would","device","one","devic","got","get","k","also"]
df["stemmed2"]=df["stemmed"].apply(lambda x: my_stop_words(x,new=new_sw))

df.to_csv(r"D:\CU\spring 2022\nlp\Roku\OS_94_t_2.csv")
